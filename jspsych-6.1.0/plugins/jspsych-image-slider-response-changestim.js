/**
 * jspsych-image-slider-response-changestim
 * Zoe Ting modified from Josh de Leeuw
 */


jsPsych.plugins['image-slider-response-changestim'] = (function() {

    var plugin = {};
  
    jsPsych.pluginAPI.registerPreload('image-slider-response-changestim', 'stimulus', 'image');
  
    plugin.info = {
      name: 'image-slider-response-changestim',
      description: '',
      parameters: {
        stimulus: {
